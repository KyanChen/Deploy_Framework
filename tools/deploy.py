...
sys.path.append('I:/CodeRep/mmsegmentation')
...
def parse_args():
    ...
    parser.add_argument('--deploy_cfg', default='../config_my/deploy_configs/segmentation_onnxruntime_static-512x512.py', help='deploy config path')
    parser.add_argument('--model_cfg', default='../config_my/model_configs/unet.py', help='model config path')
    parser.add_argument('--checkpoint', default='../pretrain/fcn_unet_s5-d16_4x4_512x1024_160k_cityscapes_20211210_145204-6860854e.pth', help='model checkpoint path')
    parser.add_argument('--img', default='../imgs/SV2-01-PMS-126-691-L00000022794.jpg', help='image used to convert model model')
    parser.add_argument(
